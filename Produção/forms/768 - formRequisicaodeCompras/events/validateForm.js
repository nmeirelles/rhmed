...
var proximaAtividade = getValue("WKNextState");
		...
		if (atividadeAtual == 4 || atividadeAtual == 0 || atividadeAtual == 86){
			...
			if (campoVazio(form, "tipoRequisicao")){
				...
				msgErro += "<li>Data Sugerida para Entrega</li>";
			}if (campoVazio(form, "ruaFornecedor")){
				msgErro += "<li>Endereço</li>";
			}if (campoVazio(form, "cidadeFornecedor")){
				msgErro += "<li>Cidade</li>";
			}if (campoVazio(form, "estadoFornecedor")){
				msgErro += "<li>Estado</li>";
			}if (campoVazio(form, "CEPFornecedor")){
				msgErro += "<li>CEP</li>";
			}if (campoVazio(form, "nomeFornecedor")){
				msgErro += "<li>Nome do Destinatário</li>";
			}if (campoVazio(form, "telefoneFornecedor")){
				msgErro += "<li>Telefone</li>";
