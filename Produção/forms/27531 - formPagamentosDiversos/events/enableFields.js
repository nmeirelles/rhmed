function enableFields(form){
	...
	if(activity != 0 || activity != 4 || activity != 86){		
		form.setEnabled("dataApuracao", false);
		form.setEnabled("codigoReceita", false);
		form.setEnabled("numReferencia", false);
		form.setEnabled("valorPrincipal", false);
		form.setEnabled("valorMulta", false);
		form.setEnabled("valorJuros", false);
		form.setEnabled("dataVencimentoNota", false);
		form.setEnabled("datapagamentoNota", false);
		form.setEnabled("valorTotalDocumento", false);
		form.setEnabled("selectTipoBusca", false);
		form.setEnabled("inputFornecedor", false);
		form.setEnabled("numCodigo", false);
		form.setEnabled("valorTotalComCodigo", false);
		form.setEnabled("dataVencimento", false);
		form.setEnabled("dataPagamento", false);
		form.setEnabled("competenciaPagamento", false);
		form.setEnabled("codigoPagamento", false);
