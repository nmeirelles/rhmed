function validateForm(form){
	...
	var proximaAtividade = getValue("WKNextState");
		...
		if (atividadeAtual == 4 || atividadeAtual == 0 || atividadeAtual == 11){
			...
			if (campoVazio(form, "inputNomePrestador")){
				msgErro += "<li>Nome do Prestador</li>";
			...
			}if (campoVazio(form, "inputCliente")){
				msgErro += "<li>Cliente</li>";
			}if (campoVazio(form, "hiddenNovoPrestador")){
				msgErro += "<li>Novo Prestador?</li>";
			}if (campoVazio(form, "hiddenOutroVinculo")){
				msgErro += "<li>Prestador possui outro vínculo empregatício?</li>";
			}if (campoVazio(form, "valorTotalDocumento")){
				msgErro += "<li>Valor Bruto do RPA</li>";
			...
			}/* if (campoVazio(form, "inputNrRPA")){
				msgErro += "<li>Nº RPA</li>";
			} */
		}
