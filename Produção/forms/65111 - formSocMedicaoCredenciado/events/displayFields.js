function displayFields(form, customHTML){
	...
	var possuiCorreio = form.getValue("inputRadioButtonCorreio");	
	if (atividade != 0 || atividade != 2 || atividade != 26){
		...
		if(possuiCorreio == "1"){
			form.setVisibleById("divTaxaInlcusa", true);
			form.setVisibleById("divValorTaxa", true);
		}else{
			form.setVisibleById("divTaxaInlcusa", false);
			form.setVisibleById("divValorTaxa", false);
		}
	}
	if (modo == "ADD"){
	...
	if (atividade == 3 || atividade == 5 || atividade == 7 || atividade == 9 || atividade == 10 || atividade == 12 || atividade == 14 || atividade == 26 || atividade == 75 || atividade == 78 || atividade == 91){
