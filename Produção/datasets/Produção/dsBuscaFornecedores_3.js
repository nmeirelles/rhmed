...
function processResult(result) {
	...
	dataset.addColumn("BANCMAT");
	dataset.addColumn("CNPJMAT");
	dataset.addColumn("CPFMEI");
	dataset.addColumn("FORNMEI");
	dataset.addColumn("TPFORN");
	...
	for (var i = 0; i < result.size(); i++) {
		dataset.addRow([
			...
			result.get(i).getUF(),
			result.get(i).getBANCMAT(),
			result.get(i).getCNPJMAT(),
			result.get(i).getCPFMEI(),
			result.get(i).getFORNMEI(),
			result.get(i).getTPFORN(),
			''
		]);
...
// k7and8.prd1.protheus.totvscloud.com.br:48124
// br.com.totvscloud.protheus.prd1.k7and8._48124

// rhmedconsultores119082.protheus.cloudtotvs.com.br:4040
// br.com.cloudtotvs.protheus.rhmedconsultores119082._4040
