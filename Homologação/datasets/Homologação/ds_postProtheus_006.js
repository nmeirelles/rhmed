...
function callService(fields, constraints, sortFields) {
	...
	var response = service.rhmws006A(
		empresa, 
		filial,
		cnpjFilial,
...
function fillITENSSC(serviceHelper, params) {
	var result = serviceHelper.instantiate("br.com.cloudtotvs.protheus.rhmedconsultores119083._4040.TCOLSSC1");
...
function fillITENSSCArray(serviceHelper, params) {
	var result = serviceHelper.instantiate("br.com.cloudtotvs.protheus.rhmedconsultores119083._4040.ARRAYOFTCOLSSC1");
...
function fillSolcomp(serviceHelper, params) {	
	var result = serviceHelper.instantiate("br.com.cloudtotvs.protheus.rhmedconsultores119083._4040.TCABSC1");
...
function data(filial,empresa,cnpjFilial,tIPOREQUIS,dTEMISSAO,nATFLUIG,pROCFLUIG,iTENSSC,sOLICITANTE,tIPOPRIORI,lOCENTREGA,aPROVADOR,fORNSUGERIDO,nUMSCSUBSTIT) {
	return {
		...
		"locatorClass" : "br.com.cloudtotvs.protheus.rhmedconsultores119083._4040.RHMWS006",
