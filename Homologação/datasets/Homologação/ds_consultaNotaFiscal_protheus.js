...
function createDataset(fields, constraints, sortFields){
    ...
    log.info("numeroNF: "+numeroNF);
    var url = "https://rhmedconsultores119083.protheus.cloudtotvs.com.br:4050/rest/WSCONSULTA?FIL="+filial+"&TABELA=SF1&FILTRO=F1_DOC$"+numeroNF+"@F1_FORNECE$"+codigoFornecedor+"&COLUNAS=F1_DOC|F1_FORNECE";
    log.info(url);
