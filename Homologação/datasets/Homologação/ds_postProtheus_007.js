...
function postTitPag(empresa, filial, cnpjFilial, tituloPagamento){
    //try{
        var url = new java.net.URL('https://rhmedconsultores119083.protheus.cloudtotvs.com.br:4050/rest/RHMWS007');
        log.info(url);
		...
		var json = {
			...
			"TITPAG":{
				...
				"TESTEEEE":tituloPagamento.mODELOPAG == null ? "" : tituloPagamento.mODELOPAG			
			}
		};
		log.dir(json);
