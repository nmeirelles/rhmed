...
function fillTSD1(serviceHelper, params) {
	var result = serviceHelper.instantiate("br.com.cloudtotvs.protheus.rhmedconsultores119083._4040.TSD1");
	...
	log.info("TOTAL SET>>>>>>>>>>>>>####:");
	log.info(params.tOTAL);

	let resultValor = result.getTOTAL();
	log.info("TOTAL GET>>>>>>>>>>>>>####:");
	log.info(resultValor);
	return result;
}

function fillARRAYOFTSD1(serviceHelper, params){
	var result = serviceHelper.instantiate("br.com.cloudtotvs.protheus.rhmedconsultores119083._4040.ARRAYOFTSD1");
...
function fillTNF(serviceHelper, params){
	var result = serviceHelper.instantiate("br.com.cloudtotvs.protheus.rhmedconsultores119083._4040.TNF");
...
function data(filial, nfentrada, empresa, cnpjFilial) {
	return {
		...
		"locatorClass" : "br.com.cloudtotvs.protheus.rhmedconsultores119083._4040.RHMWS005",
