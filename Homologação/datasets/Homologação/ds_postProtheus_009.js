...
function callService(fields, constraints, sortFields) {
	...
	var response = service.rhmws009A(
		params.empresa,
		params.filial, 
		params.cnpjfilial,
...
function fillTSD19(serviceHelper, params) {
	var result = serviceHelper.instantiate("br.com.cloudtotvs.protheus.rhmedconsultores119083._4040.TSD19");
	log.info("fillTSD19");
	log.dir(params);
...
function fillARRAYOFTSD19(serviceHelper, params) {
	var result = serviceHelper.instantiate("br.com.cloudtotvs.protheus.rhmedconsultores119083._4040.ARRAYOFTSD19");
...
function fillTNF9(serviceHelper, params) {
	var result = serviceHelper.instantiate("br.com.cloudtotvs.protheus.rhmedconsultores119083._4040.TNF9");
	log.info("fillTNF9");
	log.dir(params)
...
function data(filial, empresa, cODFORN, dTEMISSAO, dTVENCIMENTO, iTENSNF, lOJA, nATFLUIG, nUMDOC, pROCFLUIG, sERIE, cnpjfilial) {
	return {
		...
		"locatorClass" : "br.com.cloudtotvs.protheus.rhmedconsultores119083._4040.RHMWS009",
