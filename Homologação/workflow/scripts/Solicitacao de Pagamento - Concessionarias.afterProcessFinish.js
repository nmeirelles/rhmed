function afterProcessFinish(processId){
	...
	var numeroAtividadeCF = 12;
	var numeroProximaAtividadeCF = 19;
	var nomeGrupoCF = "Pool:Group:PROC_Celula_Fiscal";
	var cNumeroSolicitacaoCF = DatasetFactory.createConstraint("numeroSolicitacao", numeroSolicitacaoCF, numeroSolicitacaoCF, ConstraintType.MUST);
	var cNumeroAtividadeCF = DatasetFactory.createConstraint("numeroAtividade", numeroAtividadeCF, numeroAtividadeCF, ConstraintType.MUST);
	var cNumeroProximaAtividadeCF = DatasetFactory.createConstraint("numeroProximaAtividade", numeroProximaAtividadeCF, numeroProximaAtividadeCF, ConstraintType.MUST);
	var cNomeGrupoCF = DatasetFactory.createConstraint("nomeGrupo", nomeGrupoCF, nomeGrupoCF, ConstraintType.MUST);
	var constraintsCF = [cNumeroSolicitacaoCF,cNumeroAtividadeCF,cNumeroProximaAtividadeCF,cNomeGrupoCF];
	...
	// Get SLA - Célula Fiscal
	var numeroSolicitacaoCFA = processId;
	var numeroAtividadeCFA = 91;
	var numeroProximaAtividadeCFA = 93;
	var nomeGrupoCFA = "Pool:Group:PROC_Celula_Fiscal";
	var cNumeroSolicitacaoCFA = DatasetFactory.createConstraint("numeroSolicitacao", numeroSolicitacaoCFA, numeroSolicitacaoCFA, ConstraintType.MUST);
	var cNumeroAtividadeCFA = DatasetFactory.createConstraint("numeroAtividade", numeroAtividadeCFA, numeroAtividadeCFA, ConstraintType.MUST);
	var cNumeroProximaAtividadeCFA = DatasetFactory.createConstraint("numeroProximaAtividade", numeroProximaAtividadeCFA, numeroProximaAtividadeCFA, ConstraintType.MUST);
	var cNomeGrupoCFA = DatasetFactory.createConstraint("nomeGrupo", nomeGrupoCFA, nomeGrupoCFA, ConstraintType.MUST);
	var constraintsCFA = [cNumeroSolicitacaoCFA,cNumeroAtividadeCFA,cNumeroProximaAtividadeCFA,cNomeGrupoCFA];
	log.dir(constraintsCFA);
	var dsSLACFA = DatasetFactory.getDataset("ds_getSLA", null, constraintsCFA, null);
	log.dir(dsSLACFA);
	for(var i = 0; i < dsSLACFA.rowsCount; i++){
		var dataDisponibilidadeCFA = dsSLACFA.getValue(i, "dataDisponibilidade");
		var dataAssumiuCFA = dsSLACFA.getValue(i, "dataAssumiu");
		var dataFinalizouCFA = dsSLACFA.getValue(i, "dataFinalizou");
		var usuarioCFA = dsSLACFA.getValue(i, "usuario");
		hAPI.setCardValue("dataDisponibilidadeCFA", dataDisponibilidadeCFA);
		hAPI.setCardValue("dataAssumiuCFA", dataAssumiuCFA);
		hAPI.setCardValue("dataFinalizouCFA", dataFinalizouCFA);
		hAPI.setCardValue("usuarioCFA", usuarioCFA);
	}
	...
	var numeroAtividadeCP = 28;
	var numeroProximaAtividadeCP = 15;
	...
	var numeroAtividadeS = 75;
	var numeroProximaAtividadeS = 69;
	var nomeGrupoS = "";
	...
	var numeroAtividadeC = 78;
	var numeroProximaAtividadeC = 18;
	var nomeGrupoC = "";
	...
	if(tmpCoordenador == true){
		var numeroSolicitacaoC = processId;
		var numeroAtividadeC = 5;
		var numeroProximaAtividadeC = 16;
		var nomeGrupoC = "";
		var nomeUsuarioC = hAPI.getCardValue("aprovadorCoordenador");
		var cNumeroSolicitacaoC = DatasetFactory.createConstraint("numeroSolicitacao", numeroSolicitacaoC, numeroSolicitacaoC, ConstraintType.MUST);
		var cNumeroAtividadeC = DatasetFactory.createConstraint("numeroAtividade", numeroAtividadeC, numeroAtividadeC, ConstraintType.MUST);
	...
	var numeroAtividadeD = 10;
	var numeroProximaAtividadeD = 17;
	var nomeGrupoD = "";
