...
function definirCampoDescritor(){
    ...
    var campoDescritor = "";
    if(todasFiliais == true) campoDescritor = zoomEmpresa + " | Todas Unidades/Filiais"; 
    else if(zoomPlataforma == "EVIDAMED" || zoomPlataforma == "SOC") campoDescritor = zoomEmpresa + " | " + zoomUnidadeFilial; 
    else if(zoomPlataforma == "SOC NET") campoDescritor = zoomEmpresa + " | " + inputUnidadeFilial; 
