function displayFields(form, customHTML){
	...
	if(atividade != 0 && atividade != 4 && atividade != 102 && atividade != 11 && atividade != 124){
		form.setVisibleById('documentoAnexo', false);
	}else{
		form.setVisibleById('documentoAnexo', true);
	}

	if(atividade != 0 || atividade != 4){
		var outroVinculo = form.getValue("hiddenOutroVinculo");
		var novoPrestador = form.getValue("hiddenNovoPrestador");
		if(outroVinculo == "sim"){
			form.setVisibleById('spanOutroVinculo2', true);
		}
		if(outroVinculo == "nao" || outroVinculo == ""){
			form.setVisibleById('spanOutroVinculo2', false);
		}
		if(novoPrestador == "sim"){
			form.setVisibleById('spanNovoPrestador2', true);
		}
		if(novoPrestador == "nao" || novoPrestador == ""){
			form.setVisibleById('spanNovoPrestador2', false);
		}
	}
	...
	if (atividade == 0 || atividade == 4 || atividade == 11 || atividade == 102 || atividade == 104 || atividade == 124){		
	...
	if (atividade == 5 || atividade == 11 || atividade == 25 || atividade == 27 || atividade == 34 || atividade == 41 || atividade == 55 || atividade == 86 || atividade == 89 || atividade == 92){
