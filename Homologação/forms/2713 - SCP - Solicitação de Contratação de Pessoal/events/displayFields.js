function displayFields(form, customHTML){
	...
	if (atividade == 9 || atividade == 12 || atividade == 121 || atividade == 106){
	...
	if (atividade == 124 || atividade == 125 || atividade == 15){
		form.setVisibleById('painelAnalistasRH', true);
		//form.setVisibleById('divButtonAnexo', true);
	}else{
		form.setVisibleById('painelAnalistasRH', false);
		//form.setVisibleById('divButtonAnexo', false);
	}
